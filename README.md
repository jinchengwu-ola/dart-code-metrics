[![Build Status](https://shields.io/github/actions/workflow/status/olachat/dart-code-metrics/package_analyze.yaml?logo=github&logoColor=white&branch=master)](https://github.com/olachat/dart-code-metrics/)
[![Coverage Status](https://img.shields.io/codecov/c/github/olachat/dart-code-metrics?logo=codecov&logoColor=white)](https://codecov.io/gh/olachat/dart-code-metrics/)
...
[![License](https://img.shields.io/github/license/olachat/dart-code-metrics)](https://github.com/olachat/dart-code-metrics/blob/main/LICENSE)
[![Pub popularity](https://badgen.net/pub/popularity/dart_code_metrics)](https://pub.dev/packages/dart_code_metrics/score)
[![GitHub popularity](https://img.shields.io/github/stars/olachat/dart-code-metrics?logo=github&logoColor=white)](https://github.com/olachat/dart-code-metrics/stargazers)
...
<img
  src="assets/flutter-favorite-badge-1200px.png"
...
- See [CHANGELOG.md](./CHANGELOG.md) for major/breaking updates, and [releases](https://github.com/olachat/dart-code-metrics/releases) for a detailed version history.
- To contribute, please read [CONTRIBUTING.md](./CONTRIBUTING.md) first.
- Please [open an issue](https://github.com/olachat/dart-code-metrics/issues/new?assignees=dkrutskikh&labels=question&template=question.md&title=%5BQuestion%5D+) if anything is missing or unclear in this documentation.
...
![Console report example](assets/analyze-console-report.png)
...
![Console report example](assets/unnecessary-nullable-console-report.png)
...
![Console report example](assets/unused-files-console-report.png)
...
![Console report example](assets/unused-l10n-console-report.png)
...
![Console report example](assets/unused-code-console-report.png)
...
If you are interested in contributing, please check out the [contribution guidelines](https://github.com/olachat/dart-code-metrics/blob/main/CONTRIBUTING.md). Feedback and contributions are welcome!
