...
'''));
  ...
  Future<void> _checkForUpdates() async {
    try {
      final latestVersion = await _pubUpdater?.getLatestVersion('dart_code_metrics');
      final isUpToDate = packageVersion == latestVersion;
      if (!isUpToDate && latestVersion != null) {
        final changelogLink = 'https://github.com/olachat/dart-code-metrics/releases/tag/$latestVersion';
